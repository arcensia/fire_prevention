...
@app.route("/DHT22T") 
def DHT22Tgraph():
    return render_template('DHT22T.html')

@app.route("/DHT22H") 
def DHT22Hgraph():
    return render_template('DHT22H.html')

@app.route("/MH_Z19T") 
def MH_Z19Tgraph():
    return render_template('MH_Z19T.html')

@app.route("/MH_Z19CO2") 
def MH_Z19CO2graph():
    return render_template('MH_Z19CO2.html')
 
@app.route("/MQ2GAS") 
def MQ2GASgraph():
    return render_template('MQ2GAS.html')

@app.route("/GY_712C") 
def GY_712Cgraph():
    return render_template('GY_712C.html')
